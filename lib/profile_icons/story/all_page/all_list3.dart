...
class Newall3 extends StatelessWidget {
  const Newall3({super.key});
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                          "Ваш заказ уже в пути, вы не можете",
                          style: TextStyle(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: SizedBox(
                   width: 168,height: 82,
                    child: Text(
                      "М. Улугбекский р-н ,ул. Осиё 17 А Кардиологии Ташкент ",
                      style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15),
                    ),
                  ),
                )
          ...
          SizedBox(height: 10),
            Row(
              children: [
               ...
               child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [Text("Отмена заказа",style: TextStyle(color: Colors.red,fontWeight: FontWeight.w600,fontSize: 15),)],),
                )
              ],
            ),
